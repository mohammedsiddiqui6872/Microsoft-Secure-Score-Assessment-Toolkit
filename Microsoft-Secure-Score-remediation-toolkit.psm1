...
function Invoke-MicrosoftSecureScore {
    ...
    Write-Host "Mode: $(if ($ApplicableOnly) { 'Applicable Controls Only' } else { 'All Controls (411+)' })" -ForegroundColor Yellow
...
function Get-MicrosoftSecureScoreInfo {
    ...
    Write-Host "  Generate comprehensive security reports with 411+ Microsoft" -ForegroundColor White
    ...
    Write-Host "     Generate full assessment report (411+ controls)" -ForegroundColor Gray
